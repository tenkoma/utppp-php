...
namespace Tenkoma\UtpppExample\Test\Case\Chapter7\Listing3;

use PHPUnit\Framework\Attributes\Test;
use PHPUnit\Framework\TestCase;
use Tenkoma\UtpppExample\Chapter7\Listing3\Company;
use Tenkoma\UtpppExample\Chapter7\Listing3\User;
use Tenkoma\UtpppExample\Chapter7\Listing3\UserType;
...
class UserTest extends TestCase
{
    ...
    public function メール・アドレスを非従業員のものから従業員のものに変える(): void
    {
        ...
        $sut = new User(1, "user@gmail.com", UserType::Customer);
    ...
    public function メール・アドレスを従業員のものから非従業員のものに変える(): void
    {
        ...
        $sut = new User(1, "current@mycorp.com", UserType::Employee);
